    ...
    <footer className="mt-auto border-t border-border bg-secondary/50">
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8 text-center md:text-left">
          <div>
            <h4 className="text-xs font-medium uppercase tracking-wider mb-3 text-foreground">UK Office</h4>
            ...
            <a href="mailto:info@bauhausproduction.com" className="text-sm link-accent">
              info@bauhausproduction.com
            </a>
          </div>
          <div>
            <h4 className="text-xs font-medium uppercase tracking-wider mb-3 text-foreground">Nigeria Office</h4>
            ...
            <a href="mailto:akinalaka@bauhaus-education.co.uk" className="text-sm link-accent">
